...
urlpatterns = [
	...
	url(r'^addprofession/(?P<username>[\w\-]+)$', views.addprofession, name='addprofession'),
	url(r'^contactus/(?P<username>[\w\-]+)$', views.contactus, name='contactus'),
	url(r'^mapjs/',views.mapjs,name='mapjs'),
]